...
***Note: that the prerequisites are to install python-pip, git, and requests and flask python modules via PIP install.***

  INSTALLATION REQUIREMENTS FOR a Linux-AMI Instance
